Pod::Spec.new do |spec|
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  # 二进制依赖
  spec.source        = { :https => "https://hzkyk.obs.cn-east-3.myhuaweicloud.com/iOSFramework/UnityFramework.framework.zip" }
  # spec.source        = { :http => "http://localhost:10010/#{spec.version}/UnityFramework.framework.zip"}
